function Invoke-CIPPStandardSafeAttachmentPolicy {
    ...
    if ($MDOLicensed) {
        ...
        $PolicyList = @($PolicyName, 'Plein Sud IT - Default Safe Attachment Policy', 'Default Safe Attachment Policy')
        ...
        $RuleList = @($DesiredRuleName, 'Plein Sud IT - Default Safe Attachment Rule', 'Plein Sud IT - Default Safe Attachment Policy')
