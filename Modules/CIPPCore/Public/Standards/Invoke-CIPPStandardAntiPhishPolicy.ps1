function Invoke-CIPPStandardAntiPhishPolicy {
    ...
    $PolicyName = if ($Settings.name) { $Settings.name } else { 'Plein Sud IT - Default Anti-Phishing Policy' }
    $PolicyList = @($PolicyName, 'Plein Sud IT - Default Anti-Phishing Policy','Default Anti-Phishing Policy')
    ...
    $RuleList = @($DesiredRuleName, 'Plein Sud IT - Default Anti-Phishing Rule','CIPP Default Anti-Phishing Policy')
        ...
        if ($StateIsCorrect -eq $true) {
            ...
            if ($MDOLicensed) {
                $cmdParams = @{
                    ...
                    AdminDisplayName                    = "Politique antiphishing standard par Plein Sud IT. Ne pas modifier sans autorisation."
                }
            } else {
                $cmdParams = @{
                    Enabled                             = $true
